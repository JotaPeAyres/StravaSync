...
- **Escopo `activity:read_all`, validado no momento da troca.** A tela de consentimento do Strava tem caixas de seleção: o participante pode aprovar e desmarcar o acesso a atividades privadas. Sem conferir o escopo concedido na resposta da troca, isso só apareceria meses depois — e obrigaria a procurar a pessoa de novo. Trocar de escopo depois obriga a reautorizar **todos**.
